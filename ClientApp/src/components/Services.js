            ...
            <div className="container">
                ...
                <div className="services">
                    <div className="service">
                        <img src="https://via.placeholder.com/150x150" alt="Kitchen Remodel" />
                    ...
                    <div className="service">
                        <img src="https://via.placeholder.com/150x150" alt="Bathroom Remodel" />
                        <h3>Bathroom Remodel</h3>
                        <p>We can help you create a luxurious and functional bathroom that meets your needs and style.</p>
                    </div>
                    <div className="service">
                        <img src="https://via.placeholder.com/150x150" alt="Flooring" />
                        <h3>Flooring</h3>
                    ...
                    <div className="service">
                        <img src="https://via.placeholder.com/150x150" alt="Appliance Installation" />
                    ...
                    <div className="service">
                        <img src="https://via.placeholder.com/150x150" alt="Electrical Troubleshooting" />
